  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-100 to-purple-200">
      <div className="bg-white shadow-lg rounded-xl p-10 w-full max-w-md flex flex-col items-center">
        <h1 className="text-3xl font-bold mb-4 text-purple-700 text-center">Change Photos Name</h1>
        <p className="text-lg text-gray-600 mb-8 text-center">Click the button below to upload your photos.</p>
       ...
       <input
        ...
        <button
          ...
          className="bg-purple-600 text-white px-6 py-3 rounded-lg shadow">
            Upload Photos
            </button>
        ...
        <button
          ...
          className="mt-6 bg-blue-600 text-white px-6 py-3 rounded-lg shadow">
            Download All File
        </button>
        <button
          onClick={downloadZip}
          className="mt-6 bg-blue-400 text-white px-6 py-3 rounded-lg shadow">
            Download Zip
        </button>
        </div>
        <br/>
